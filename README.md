...
I'm a Software Engineer at IBM on **Event Streams** (Apache Kafka on Kubernetes/OpenShift). Previously an AI engineer at impress.ai. I write about event streaming, MCP, connectors, and shipping production systems.

- Currently building and writing about Kafka, MCP servers, and event-driven platforms
- Continuously learning distributed systems, Kubernetes operators, and AI tooling
- Ask me about Kafka, Kafka Connect, Kubernetes, or Python/Java backends
...
| Area | Technologies |
| ---- | ------------ |
| Distributed systems | Kafka, Kafka Connect, Kubernetes operators, Apicurio Registry, IBM MQ |
| Languages | Python, Java, Go, JavaScript, TypeScript, SQL, Bash |
| Backend & data | Django, DRF, Celery, Redis, PostgreSQL, Elasticsearch |
| Cloud & DevOps | AWS, IBM Cloud, Docker, OpenShift, Jenkins, Keycloak |
| AI tooling | MCP, RAG, FastAPI |
...
Feel free to open issues or PRs — happy to collaborate on open source.
