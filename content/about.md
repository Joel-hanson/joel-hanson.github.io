...
- **Distributed systems:** Apache Kafka, Kafka Connect, Kubernetes operators, event-driven architectures, Apicurio Registry
- **Backend & data:** Django, DRF, Celery, Redis, PostgreSQL, Elasticsearch, REST APIs, IBM MQ
- **Cloud & DevOps:** AWS (EC2, S3, SQS, EKS), Docker, OpenShift, Jenkins, GitLab CI, Keycloak, IBM Cloud
...
<a href="/files/Resume%20-%20Joel%20Hanson.pdf" download>Resume (PDF)</a>
